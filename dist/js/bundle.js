...
getButton.addEventListener('click', (event) => {
    ...
    // console.log(getForm.elements.name.value);
    // console.log(getForm.elements.phone.value);
    // console.log(getForm.elements.text.value);
    // console.log(getForm.elements.phone.value);
    ...
    console.log(validateForm(getForm));
...
// json.setRequestHeader('Content-Type', 'text/plain')
        // json.send(JSON.stringify(formData));
        json.send(formData);
        
        json.addEventListener('load', () => {
            
            // console.log(String.fromCharCode(json.response.message));
            if (json.response) {
